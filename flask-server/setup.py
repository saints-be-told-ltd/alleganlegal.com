...
setuptools.setup(
    ...
    description="Find professional legal services in Allegan, Michigan.",
    url='https://alleganlegal.com',
    author='Michael alleganlegal',
    author_email='base64(aG95dC5uaXhAZ21haWwuY29t)',
    packages=setuptools.find_packages(),
    entry_points={'console_scripts': ['alleganlegal = cli.cli:cli']},
